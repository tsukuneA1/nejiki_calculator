...
export default function InstructionManual() {
  return (
    <>
      <Head>
        <title>
          金ネジキ攻略ガイド | ポケモンバトルファクトリー 使い方マニュアル
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="金ネジキ,攻略ガイド,使い方,マニュアル,ポケモン,バトルファクトリー,ダメージ計算,プラチナ,HGSS,解説"
        />
        <meta
          property="og:title"
          content="金ネジキ攻略ガイド | ポケモンバトルファクトリー 使い方マニュアル"
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content="金ネジキ攻略ガイド | 使い方マニュアル"
        />
        <meta
          name="twitter:description"
          content="金ネジキ攻略に必須のダメージ計算機の使い方を詳しく解説。"
        />
        <meta
          name="twitter:image"
          content="https://nejiki-calculator.com/images/nejiki_image.png"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "ポケモンバトルファクトリーダメージ計算機の詳しい使い方ガイド",
              ...
              totalTime: "PT15M",
              supply: ["ポケモンプラチナまたはHGSS", "インターネット接続"],
              tool: ["ウェブブラウザ", "スマートフォンまたはPC"],
          ...
          <section id="basic-setup" className="mb-12">
            ...
            <div className="bg-yellow-50 p-6 rounded-lg mb-6">
              ...
              <ol className="list-decimal list-inside space-y-3 text-gray-700">
                ...
                <li>
                  <strong>周回回数</strong>
                  ：現在の挑戦回数を選択（使用可能ポケモンが自動でフィルタリングされます）
                </li>
              </ol>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-blue-800 text-sm">
                💡 <strong>ヒント</strong>
                ：周回回数を設定すると、その回数で使用できるポケモンのみが表示され、個体値も自動的に適切な値に設定されます。
              </p>
            </div>
          </section>
          ...
          <section id="attacker-setup" className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-red-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    ✅ <strong>ポケモン選択</strong>
                    ：オートコンプリート機能で検索
                  </li>
                  <li>
                    ✅ <strong>使用技</strong>：ダメージ計算の基準となる技
                  </li>
                </ul>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    ⚡ <strong>特性</strong>：ダメージに影響する特性を選択
                  </li>
                  <li>
                    🎒 <strong>持ち物</strong>：攻撃力を上げるアイテムなど
                  </li>
                  <li>
                    📈 <strong>ランク補正</strong>：攻撃・特攻のランク変化
                  </li>
                  <li>
                    💥 <strong>急所</strong>：急所に当たった場合の計算
                  </li>
                  <li>
                    🔥 <strong>やけど</strong>：物理技の威力半減
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-6 p-4 bg-green-50 rounded-lg">
              <p className="text-green-800 text-sm">
                🎯 <strong>操作のコツ</strong>
                ：ポケモン名を入力すると候補が表示されます。部分一致でも検索できるので、「ガブ」と入力すれば「ガブリアス」が見つかります。
              </p>
            </div>
          </section>
          ...
          <section id="defender-setup" className="mb-12">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    🛡️ <strong>防御ランク</strong>：-6〜+6で設定
                  </li>
                  <li>
                    ✨ <strong>特防ランク</strong>：-6〜+6で設定
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-4 p-4 bg-purple-50 rounded-lg">
              <p className="text-purple-800 text-sm">
                🔄 <strong>便利機能</strong>
                ：画面中央の「⇄」ボタンで攻撃側と防御側のポケモンを瞬時に入れ替えできます。
              </p>
            </div>
          </section>
          ...
          <section id="reserve-pokemon" className="mb-12">
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              <p className="text-orange-800 text-sm">
                ⚠️ <strong>制限</strong>
                ：攻撃側・防御側それぞれ最大6匹まで控えポケモンを保存できます。
              </p>
            </div>
          </section>
          ...
          <section id="multiple-attackers" className="mb-12">
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <div className="bg-white p-4 rounded border-l-4 border-purple-400">
                <p className="text-purple-800 text-sm">
                  💪 <strong>活用例</strong>
                  ：味方複数でのコンボ攻撃や、異なる技での与ダメージ比較に使用できます。
                </p>
              </div>
            </div>
          </section>
