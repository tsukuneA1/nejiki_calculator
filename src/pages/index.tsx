...
export default function Home() {
  ...
  return (
    <MainLayout>
      ...
      <Checkbox id="terms" checked={level == 50} onClick={() => handleLevelChange(50)} className='w-5 h-5 border-2'/>
      <label
        htmlFor="terms"
      ...
      <Checkbox id="terms" checked={level == 100} onClick={() => handleLevelChange(100)} className='w-5 h-5 border-2'/>
      <label
        htmlFor="terms"
        className="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
      >
